  ...
  const actionCards = [
    {
      ...
      path: matkul ? `/superadmin/manajemen/materi/tambah?prodiId=${matkul.prodiId}&mataKuliahId=${matkul.id}` : "/superadmin/manajemen/materi/tambah",
    },
    {
      label: "Buat\nKuis",
      color: "from-purple-400 to-purple-500",
      icon: <FileQuestion size={22} className="text-white" />,
      path: matkul ? `/superadmin/manajemen/latihan-soal/tambah?prodiId=${matkul.prodiId}&mataKuliahId=${matkul.id}` : "/superadmin/manajemen/latihan-soal/tambah",
    },
    {
      label: "Buat\nSmart Video",
      color: "from-green-300 to-green-400",
      icon: <Video size={22} className="text-white" />,
      path: matkul ? `/superadmin/manajemen/video/tambah?prodiId=${matkul.prodiId}&mataKuliahId=${matkul.id}` : "/superadmin/manajemen/video/tambah",
    },
    {
      label: "Buat\nResponsi",
      color: "from-blue-400 to-blue-500",
      icon: <FileQuestion size={22} className="text-white" />,
      path: matkul ? `/superadmin/manajemen/responsi/tambah?prodiId=${matkul.prodiId}&mataKuliahId=${matkul.id}` : "/superadmin/manajemen/responsi/tambah",
    },
  ];
          ...
          <div className="space-y-3">
              ...
              >
                ...
                <div className="flex-shrink-0 flex items-center gap-2">
                  {canManage && (
                    <>
                      <button
                        onClick={() => router.push(`/superadmin/manajemen/responsi/edit/${res.id}`)}
                        className="flex items-center gap-1.5 px-3 py-2 bg-amber-100 text-amber-700 rounded-xl text-xs font-semibold hover:bg-amber-200 transition-colors shadow-sm"
                      >
                        <Edit size={13} /> Edit
                      </button>
            ...
            {showMateri && materi.length === 0 && (activeFilter === "e-materi") && (
              <div className="bg-white rounded-2xl border border-dashed border-gray-200 p-8 text-center text-gray-400 text-sm">
                ...
                {canManage && (
                  <button
                    onClick={() => router.push(matkul ? `/superadmin/manajemen/materi/tambah?prodiId=${matkul.prodiId}&mataKuliahId=${matkul.id}` : "/superadmin/manajemen/materi/tambah")}
            ...
            {showVideos && videos.length === 0 && activeFilter === "video" && (
              <div className="bg-white rounded-2xl border border-dashed border-gray-200 p-8 text-center text-gray-400 text-sm">
                ...
                {canManage && (
                  <button
                    onClick={() => router.push(matkul ? `/superadmin/manajemen/video/tambah?prodiId=${matkul.prodiId}&mataKuliahId=${matkul.id}` : "/superadmin/manajemen/video/tambah")}
            ...
            {showExercises && exercises.length === 0 && activeFilter === "bank-soal" && (
              <div className="bg-white rounded-2xl border border-dashed border-gray-200 p-8 text-center text-gray-400 text-sm">
                ...
                {canManage && (
                  <button
                    onClick={() => router.push(matkul ? `/superadmin/manajemen/latihan-soal/tambah?prodiId=${matkul.prodiId}&mataKuliahId=${matkul.id}` : "/superadmin/manajemen/latihan-soal/tambah")}
            ...
            {showResponsies && responsies.length === 0 && activeFilter === "responsi" && (
              <div className="bg-white rounded-2xl border border-dashed border-gray-200 p-8 text-center text-gray-400 text-sm">
                ...
                {canManage && (
                  <button
                    onClick={() => router.push(matkul ? `/superadmin/manajemen/responsi/tambah?prodiId=${matkul.prodiId}&mataKuliahId=${matkul.id}` : "/superadmin/manajemen/responsi/tambah")}
