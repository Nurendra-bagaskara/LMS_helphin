...
export default function LogoFakultas({ label, onLogoChange }) {
    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            ...
            reader.onloadend = () => {
                ...
                // Untuk kirim data ke Buat-Akun-Fakultas
    ...
    return (
        <div className="w-full max-w-[1019px] flex flex-col gap-[12px]">
            <h4 className="text-[14px] font-semibold text-black leading-[20px]">
                {label}
            </h4>

            <div className="w-full h-[124px] bg-white border border-[#E6E6E6] rounded-[4px] flex items-center justify-center relative shadow-sm overflow-hidden transition-all hover:bg-gray-50">
                {!filePreview ? (
                    ...
                    /* Preview Gambar & Ikon Tong Sampah */
                    <FilePreview 
                        name={fileInfo.name} 
                        size={fileInfo.size} 
                        preview={filePreview} 
